...
const Footer = () => (
  <footer className="bg-dark text-white py-4">
    <div className="container">
      <div className="row align-items-start"> {/* Ensures both sections are aligned at the top */}
        
        {/* Quick Links on the Left */}
        <div className="col-md-4">
          <h5 className="mb-3 mt-1 fw-bold">QUICK LINKS</h5> {/* Adjusted mt-2 to move it up */}
          <a href="#privacy" className="d-block text-white text-decoration-underline">Privacy Policy</a>
          <a href="#terms" className="d-block text-white text-decoration-underline">Terms of Service</a>
          <a href="#contact" className="d-block text-white text-decoration-underline">Contact Us</a>
        </div>
